  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-end">
        ...
        {/* Left Column: Interactive Intro & Headline (Shifted upward independently) */}
        <div ref={leftColRef} className="lg:col-span-7 space-y-6 text-left self-center -mt-4 lg:-mt-8 pb-8 sm:pb-10">
