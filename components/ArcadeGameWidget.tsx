    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-40 animate-bounce">
        <button
          ...
          className="group relative flex items-center gap-3 px-5 py-3 rounded-full bg-slate-900 border border-teal-500/60 text-white shadow-2xl hover:scale-105 hover:bg-slate-800 transition-all duration-300 overflow-hidden"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 via-emerald-500/20 to-teal-500/20 animate-pulse pointer-events-none" />

          <div className="w-8 h-8 rounded-full bg-teal-500 flex items-center justify-center text-slate-950 font-bold shadow-md shrink-0 group-hover:rotate-12 transition-transform">
